...
// echo "私の名前は「安藤」です。";
// echo "私の名前は「tanaka」です。";
// echo "私の名前は「yamada」です。";
...
foreach ($array as $key => $value) {//定義$arrayを$key => $valueとしている
    ...
    echo $key; 
/*      (⬆️🟡breakが正しく処理されているのか確認する方法
        実行結果→東京都神奈川県千葉県埼玉県の県庁所在地はさいたま市です。
        :この場合、配列内の埼玉以下の都道府県が出力されていないことから、
        breakが正しく実行されていることが分かる。)
*/}
...
//税抜き価格を引数に受け取って税込価格に変換して返す関数を、
// calcTaxInPrice という名前で定義してください。
